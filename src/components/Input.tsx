			...
			className={
				replaceWrapperCls
					...
					: `w-full border-[1px] rounded-md ${
							!isInvalid
								? "border-appGray/50 hover:ring-[3px] hover:ring-grayborder-appGray/50 focus-within:border-appText"
		...
		>
			<input
				className={
					replaceClass
						? className
						: `w-full p-1 rounded-md border-none focus:outline-none ${className}`
				}
				{...props}
				style={{ ...style }}
			/>
